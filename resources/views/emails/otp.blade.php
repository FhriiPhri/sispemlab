...
<body>
    <div class="wrapper">
        <div class="header">
            <h1>SispemTB</h1>
            <p>Sistem Peminjaman Alat SMK Taruna Bhakti Depok</p>
        </div>
        ...
        <div class="body">
            ...
            <div class="warning">
                <strong>Penting:</strong> Jangan bagikan kode ini kepada siapapun. Pihak sekolah tidak akan pernah
                meminta kode ini melalui media apapun.
            </div>
